...
// File: tools/flagsetup/sentinel.go
// The generator's sentinel errors. The generator imports nothing from this
// module, so it declares its own.
...
//   - errParamFlags is the category root for a broken parameter flag document. A
//     document that cannot be read, and generated source that cannot be formatted
//     or written, wrap it beside the failure's own cause.
